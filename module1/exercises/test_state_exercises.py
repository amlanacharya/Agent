...
def test_task_state_manager():
    ...
    # Add tasks
    task1_id = task_manager.create_task("Complete project proposal", priority="high", due_date="2023-12-15")
    task2_id = task_manager.create_task("Schedule team meeting", priority="medium", due_date="2023-12-10")
    task3_id = task_manager.create_task("Review documentation", priority="low")
