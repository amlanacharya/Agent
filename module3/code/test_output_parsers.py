...
class TestOutputParsers(unittest.TestCase):
    ...
    def test_simulate_llm_call(self):
        ...
        # Test with person prompt
        person_prompt = "Extract information about John Doe."
        person_output = simulate_llm_call(person_prompt)
        self.assertIn("John Doe", person_output)
        self.assertIn("software engineer", person_output)
        
        # Test with contact form prompt
        form_prompt = "Extract the contact form information for Sarah Johnson."
        form_output = simulate_llm_call(form_prompt)
        self.assertIn("Sarah Johnson", form_output)
        self.assertIn("sarah.johnson@example.com", form_output)
