...
------------------
This script demonstrates how to use the Finance Tool with an agent.
"""
...
def main():
    """Run the example."""
    print_section("Finance Agent Example")
    ...
    try:
        finance_tool = FinanceTool(api_key=alphavantage_api_key)
